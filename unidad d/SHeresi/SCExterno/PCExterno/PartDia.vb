...
Public Class PartDia
    ...
    Private Sub EliminarT_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles EliminarT.Click
        ...
        Catch ex As Exception
            MessageBox.Show("Seleccione un registro válido", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error)
            Exit Sub
        End Try
    End Sub
    ...
    Private Sub Guardar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Guardar.Click
        ...
        Try
            ...
            cn.Close()
        Catch ex As Exception
            MessageBox.Show("Error extrayendo ID de la Enfermera " & ex.Message)
        End Try
        ...
        Else
            ...
            Try
                ...
                cn.Close()
            Catch ex As Exception
                MessageBox.Show("No se puede guardar. Por favor revise los datos ingresados", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error)
            End Try
            'Modulo de limpieza
            NHClinica.Text = ""
            ApePat.Text = ""
