...
Public Class MContPac
    ...
    Private Sub Guardar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Guardar.Click
        ...
        If Editar_Registro = True Then
            Try 'Para Editar y Guardar Registros
                ...
                Dim cmd As New SqlCommand("sp_AcPac", cn)
        ...
        Else
            Try 'Para solo Guardar Registros
                Dim cmd As New SqlCommand("sp_IcPac", cn)
                cmd.CommandType = CommandType.StoredProcedure
                cmd.Parameters.Add("@descripcion", SqlDbType.VarChar, 20).Value = Descripcion.Text
                cn.Open()
                cmd.ExecuteNonQuery()
                ...
                Descripcion.Focus()
            Catch ex As Exception
                MessageBox.Show("Se encontró un error en la aplicación y no se pudo guardar el registro: " & ex.Message, "Error", MessageBoxButtons.OK, MessageBoxIcon.Error)
                Exit Sub
            Finally
                cn.Close()
            End Try
    ...
    Private Sub MContPac_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
            If Editar_Registro = True Then
                'Refrescando la Grilla con el valor seleccionado para actualizar
                Dim cmdr As New SqlCommand("sp_MURcPac", cn)
                ...
                Dim cmd As New SqlCommand("sp_RDcPac", cn)
                cmd.CommandType = CommandType.StoredProcedure
                cmd.Parameters.Add("@Index", SqlDbType.Int).Value = CInt(Index)
