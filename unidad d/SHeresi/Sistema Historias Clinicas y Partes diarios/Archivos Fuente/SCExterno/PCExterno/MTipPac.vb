...
Public Class MTipPac
    ...
    Private Sub Guardar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Guardar.Click
        ...
        If Editar_Registro = True Then
            Try 'Para Editar y Guardar Registros
                ...
                Dim cmd As New SqlCommand("sp_ATipPac", cn)
                cmd.CommandType = CommandType.StoredProcedure
                cmd.Parameters.Add("@Index", SqlDbType.Int).Value = CInt(Index)
                cmd.Parameters.Add("@Codigo", SqlDbType.Char, 5).Value = Codigo.Text
        ...
        Else
            Try 'Para solo Guardar Registros
                Dim cmd As New SqlCommand("sp_ITipPac", cn)
                cmd.CommandType = CommandType.StoredProcedure
                cmd.Parameters.Add("@Codigo", SqlDbType.Char, 5).Value = Codigo.Text
                cmd.Parameters.Add("@Descripcion", SqlDbType.VarChar, 20).Value = Descripcion.Text
                cn.Open()
    ...
    Private Sub MTipPac_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
            If Editar_Registro = True Then
                'Refrescando la Grilla con el valor seleccionado para actualizar
                Dim cmdr As New SqlCommand("sp_MURTipPac", cn)
                ...
                Dim cmd As New SqlCommand("sp_RDTipPac", cn)
                cmd.CommandType = CommandType.StoredProcedure
                cmd.Parameters.Add("@Index", SqlDbType.Int).Value = CInt(Index)
                ...
                cmd.ExecuteReader()
                cn.Close()
                Codigo.Text = cmd.Parameters("@Codigo").Value
