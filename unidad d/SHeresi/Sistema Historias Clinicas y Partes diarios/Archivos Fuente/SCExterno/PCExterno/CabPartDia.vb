    ...
    Private Sub Aceptar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Aceptar.Click
        Try
            ...
            Catch ex As Exception
                MessageBox.Show("Se generó un error al insertar el registro: " & ex.Message, "Error", MessageBoxButtons.OK, MessageBoxIcon.Error)
                Exit Sub
            Finally
                cn.Close()
            End Try
            Try
                ...
                cn.Close()
            Catch ex As Exception
                MessageBox.Show("Se generó un error al intentar obtener el número de parte diario: " & ex.Message, "Error", MessageBoxButtons.OK, MessageBoxIcon.Error)
                Exit Sub
            Finally
                cn.Close()
            End Try
